...
<head>
    ...
    <title>Ajouter un Moût</title>
    <!-- Lien vers Bootstrap CSS -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container my-5">
        <h1 class="mb-4 text-center">Ajouter un Moût</h1>
        ...
        <!-- Formulaire d'ajout -->
        <form action="{{ route('mouts.store') }}" method="POST">
            @csrf
            <div class="mb-3">
                <label for="volume" class="form-label">Volume :</label>
                <input type="number" id="volume" name="volume" value="{{ old('volume') }}" class="form-control" required>
            </div>

            <div class="mb-3">
                <label for="type" class="form-label">Type :</label>
                <input type="text" id="type" name="type" value="{{ old('type') }}" class="form-control" required>
            </div>
